...
keywords: R,vectors
abstract: >
   A list is an information container. It can hold, literally, any
   kind of R object.  With freedom, you also have responsibility.
fontsize: 12pt
...
#### The single [ {.bs-callout .bs-callout-blue}
...
#### The double [[ {.bs-callout .bs-callout-orange}
...
#### 1 The Easy way {.bs-callout .bs-callout-gray}
...
#### 2 The More Disciplined & Better Way {.bs-callout .bs-callout-orange}
...
## 1. Basic lapply with one-argument function {.bs-callout .bs-callout-orange}
...
#### Watch out about using for loops. {.bs-callout .bs-callout-orange}

There is *social stigma*! If you go to StackExchange or the "r-help"
list with example code that uses a for loop, you will often be shouted
at because for loops are slow in R.
...
The first argument to print MUST BE the element pulled from mylist3,
while arguments passed to print are named after.

The digits argument is COMMON across the calls to print. It is not
"vectorized".  
...
Return from list is always a list. Sometimes it can be
   ...
   * a list in which each item is a vector with just one element.  We'd
like to just have a vector.
   * a list of vectors,  we might
like to have the vector stacked as columns or rows in a matrix. 
...
#### The unlist() function {.bs-callout .bs-callout-orange}
