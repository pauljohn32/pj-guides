...
###################################################
### code chunk number 1: summeR-1-5-lineart-uniquebackupstring.Rnw:34-35
###################################################
...
###################################################
### code chunk number 4: empty1
###################################################
plot(x = c(-5, 5), y = c(-10, 20))


###################################################
### code chunk number 5: empty2
###################################################
plot(x = c(-5, 5), y = c(-10, 20), type = "n", axes = FALSE, xlab = "", ylab = "")


###################################################
### code chunk number 6: margins1
###################################################
...
###################################################
### code chunk number 7: summeR-1-5-lineart-uniquebackupstring.Rnw:608-611
###################################################
plot(x = c(-5, 5), y = c(-10, 20), 
    type = "n", xlab = "", ylab = "")
...
###################################################
### code chunk number 14: summeR-1-5-lineart-uniquebackupstring.Rnw:729-730
###################################################
plot(y ~ x, axes = FALSE, xlab = "", ylab = "")


###################################################
### code chunk number 15: arrows10
###################################################
bdraw()
...
###################################################
### code chunk number 37: summeR-1-5-lineart-uniquebackupstring.Rnw:1150-1155 (eval = FALSE)
###################################################
## plot(1:10, 1:10, type = "n")
