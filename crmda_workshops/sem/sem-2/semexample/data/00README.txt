...
Health Behaviors in School Children (HBSC) Files:

These files were subsetted from the original data, which was downloaded from the ICPSR webiste. 
More information about these data are available here: 
http://www.icpsr.umich.edu/icpsrweb/NAHDAP/studies/28241/version/1



hbsc.rds: an RDS-saved snapshot of the result from running
a data import that assigns values with variable key.

hbsc-subset2.zip: a collection of the raw data and a column-name
file that can serve as the starting point for analysis. files are
  hbsc-subset2/hbsc-subset2-key2.csv
  hbsc-subset2/hbsc-subset2.dat
  hbsc-subset2/hbsc-subset2-colnames.txt
