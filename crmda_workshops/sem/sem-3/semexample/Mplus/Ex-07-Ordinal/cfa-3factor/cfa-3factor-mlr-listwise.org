...
with Listwise Deletion 3-Factor CFA Model for Bullied, Alcohol, and Depression;
#+END_SRC
...
MODEL:
  ...
  Bulliedy@1 Alcohol@1 Depress@1;
#+END_SRC
...
#+BEGIN_SRC sh :results output org :exports both
	mplus cfa-3factor-mlr-listwise.inp
#+END_SRC
...
#+BEGIN_SRC org
     ...
     Running input file 'cfa-3factor-mlr-listwise.inp'...

     Beginning Time:  16:54:27
        Ending Time:  16:54:27
       Elapsed Time:  00:00:00

     Output saved in 'cfa-3factor-mlr-listwise.out'.
#+END_SRC

* Review the Results
Click [[file:cfa-3factor-mlr-listwise.out][cfa-3factor-mlr-listwise.out]] to see the output.
