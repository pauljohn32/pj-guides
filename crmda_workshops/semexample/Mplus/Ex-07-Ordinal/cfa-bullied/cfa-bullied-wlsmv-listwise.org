...
with Listwise Deletion 1-Factor for Got Bullied by Others;
#+END_SRC
...
#+BEGIN_SRC sh :results output org :exports both
	mplus cfa-bullied-wlsmv-listwise.inp
#+END_SRC
...
#+BEGIN_SRC org
     ...
     Running input file 'cfa-bullied-wlsmv-listwise.inp'...

     Beginning Time:  13:50:27
        Ending Time:  13:50:27
       Elapsed Time:  00:00:00

     Output saved in 'cfa-bullied-wlsmv-listwise.out'.
#+END_SRC

* Review the Results
Click [[file:cfa-bullied-wlsmv-listwise.out][cfa-bullied-wlsmv-listwise.out]] to see the output.
