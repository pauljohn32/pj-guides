...
with Listiwse Deletion 1-Factor CFA Model for Got Bullied by Others;
#+END_SRC
...
#+BEGIN_SRC sh :results output org :exports both
	mplus cfa-bullied-mlr-listwise.inp
#+END_SRC
...
#+BEGIN_SRC org
     ...
     Running input file 'cfa-bullied-mlr-listwise.inp'...

     Beginning Time:  13:48:19
        Ending Time:  13:48:19
       Elapsed Time:  00:00:00

     Output saved in 'cfa-bullied-mlr-listwise.out'.
#+END_SRC

* Review the Results
Click [[file:cfa-bullied-mlr-listwise.out][cfa-bullied-mlr-listwise.out]] to see the output.
