...
/*
 New Feature:
 example-3.c. randomizes the seed value so running this over
 and over produces various results.
 */
...
int main (void)
{
  ...
  gsl_rng_set(r, time(NULL)); //use time to randomly seed the generator
...
/*
Local Variables:
compile-command: "gcc -o program -Wall example-3.c -lgsl -lgslcblas -lm"
End:
*/
