...
main (void)
{
  ...
  printf("term-by-term sum = % .16f using %lu terms\n", 
         w->sum_plain, w->terms_used);

  printf("exact value      = % .16f\n", zeta_2);
  printf("accelerated sum  = % .16f using %lu terms\n", 
...
/*
Local Variables:
compile-command: "gcc -o program -Wall example-20-acceleration_test.c -lgsl -lgslcblas -lm"
End:
*/
